...
namespace Aliyun.Credentials.Provider
{
    ...
    /// <remarks>
    /// <list type="bullet">
    /// <item><description>If the <c>xx_ACCESS_KEY_ID</c> and <c>xx_ACCESS_KEY_SECRET</c> environment variables are defined and are not empty, the program will use them to create default credentials.</description></item>
    /// <item><description>If the <c>xx_ACCESS_KEY_ID</c>, <c>xx_ACCESS_KEY_SECRET</c> and <c>xx_SECURITY_TOKEN</c> environment variables are defined and are not empty, the program will use them to create temporary security credentials(STS). Note: This token has an expiration time, it is recommended to use it in a temporary environment.</description></item>
    /// </list>
    /// </remarks>
